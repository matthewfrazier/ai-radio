...
def build_hour(hour, opts=None):
    ...
    with role tags and per-hour variation. opts overrides:
    day_parts, weather_location, voice, llm_backend, llm_model."""
    opts = opts or {}
    ...
    return [
        tts("weather", {"topic": "weather", "location": location, "ttl_s": 1800}),
        ...
        {"id": "music_1", "role": "music_1", "type": "music", "params": {"query": g1, "duration_s": MUSIC_1_S}},
        {"id": "news_3", "role": "news_3", "type": "live", "params": {"source_id": b3, "duration_s": 300}},
        tts("recap_mid", {"topic": "recap", "scope": "music", "include_factoid": True,
                          "ttl_s": 0, "llm_backend": backend, "llm_model": model}),
        {"id": "music_2", "role": "music_2", "type": "music", "params": {"query": g2, "duration_s": MUSIC_2_S}},
        {"id": "news_fresh", "role": "news_fresh", "type": "live", "params": {"source_id": "auto", "duration_s": 300}},
        tts("recap_hour", {"topic": "recap", "scope": "hour", "ttl_s": 0,
